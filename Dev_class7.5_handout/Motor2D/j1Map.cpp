...
void j1Map::PropagateBFS(iPoint position)
{
	...
	// pop the last one and calculate its 4 neighbors
		if (frontier.start != nullptr) {
			...
			iPoint neighbourright = pos + iPoint(1, 0);
			iPoint neighbourleft = pos + iPoint(-1, 0);

			iPoint neighbourup = pos + iPoint(0, 1);
			iPoint neighbourdown = pos + iPoint(0, -1);
